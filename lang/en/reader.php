...
//$string['select_course_text'] = 'Quizzes must be installed in a course that is separate from the course that the students will log into when they take quizzes.  If you already have such a course select \"an existing course\" below. Otherwise, select \"Create new course.\"';
